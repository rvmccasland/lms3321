...
CREATE TABLE `enrolls` (
  ...
  `Course_Enroll_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`Enrolmentl_id`),
  KEY `Course_Enroll_id` (`Course_Enroll_id`),
  CONSTRAINT `enrolls_ibfk_2` FOREIGN KEY (`Course_Enroll_id`) REFERENCES `course` (`course_id`)
